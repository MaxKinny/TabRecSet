...
if __name__ == '__main__':
    path = "X:/LAB/dataset/CurveTabSet/chinese_no-line/TSR_TCR_annotation/"
    path_2 = "X:/LAB/dataset/CurveTabSet/english_no-line/TSR_TCR_annotation/"
    ...
    ######################### 单元格数 #######################
    # plt.hist(cell_nums, bins=7, rwidth=0.8,
    #          range=(1, 351),
    #          align='left', alpha=0.5,stacked=True, log=True)
    ...
    ######################### 跨行 #######################
    # plt.hist(rows_nums, bins=7, rwidth=0.8,
    #          range=(1, 42),
    #          align='left', alpha=0.5, stacked=True, log=True)
    ...
    ######################### 跨列 #######################
    # plt.hist(cols_nums, bins=7, rwidth=0.8,
    #          range=(1, 25),
    #          align='left', alpha=0.5, stacked=True, log=True)
